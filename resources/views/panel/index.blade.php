                ...
                <div class="row">
                    ...
                    <div class="col-8 row ml-3 mt-2 mb-5">
                        <div class="col-md-2">
                            <form >
                                ...
                                <button class="btn btn-light w-100 btn-filter {{ isset($filter) && $filter == 1 ? 'btn-filter-active' : '' }}"><i class="fas fa-calendar-day"></i> Mes actual</button>
                            </form>
                        </div>
                        ...
                        <div class="col-md-2">
                            <form >
                                ...
                                <button class="btn btn-light w-100 btn-filter {{ isset($filter) && $filter == 2 ? 'btn-filter-active' : '' }}"><i class="fas fa-calendar-week"></i> Semestral</button>
                            </form>
                        </div>
                        ...
                        <div class="col-md-2">
                            <form>
                                ...
                                <button class="btn btn-light w-100 btn-filter {{ isset($filter) && $filter == 3 ? 'btn-filter-active' : '' }}"><i class="far fa-calendar-alt"></i> Anual</button>
                            </form>
                        </div>
                        ...
                        <div class="col-md-2">
                            <form >
                                ...
                                <button class="btn btn-light w-100 btn-filter {{ isset($filter) && $filter == 4 ? 'btn-filter-active' : '' }}"><i class="fas fa-clipboard-list"></i> Total</button>
                            </form>
                        </div>
                    </div>
                    ...
                    @if(Auth::user()->role_id !== 2)
                      <div class="col-6 my-5">
                          <h3 class="chart-title">Top Empresas que mas publicaron ({{ $title }})</h3>
                          <div id="chartdiv-companies"></div>
                      </div>

                      <div class="col-6 my-5">
                          <h3 class="chart-title">Top Usuarios mas activos ({{ $title }})</h3>
...
var chartData = {!! json_encode($registeredRaffles) !!};
var centerLabel = {!! json_encode($title) !!};
...
var chartData = {!! json_encode($ticketsTransactions)!!};
var centerLabel = {!! json_encode($title) !!};
...
var chartData = {!! json_encode($movements)!!};
var centerLabel = {!! json_encode($title) !!};
...
var chartData = {!! json_encode($companiesUsers) !!};
var centerLabel = {!! json_encode($title) !!};
...
$.each(chartData, function(index, value){
    ...
    chartData[index]['pictureSettings'] = {src: "{{ asset('storage/users') }}/" + value.photo};
});
