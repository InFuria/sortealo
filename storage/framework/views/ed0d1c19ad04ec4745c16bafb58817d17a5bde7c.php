<?php $__env->startSection('title', 'Editar Sorteo'); ?>
        ...
        <div class="content special-card col-md-11 pt-3 mx-auto min-vh-100">
            <div class="card bg-light col-12 min-vh-100 my-5">
                ...
                <div class="card-body d-flex justify-content-center align-items-center col-11 mx-auto">
                    <?php echo Form::model($raffle, ['route' => ['raffles.update', $raffle->id], 'method' => 'post', 'class' => 'col-md-10', 'files' => true]); ?>

                        <?php echo method_field('PUT'); ?>
                        <?php echo $__env->make('raffles.partials._form', ['button' => 'Actualizar'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php echo Form::close(); ?>
...
<?php echo $__env->make('raffles.partials._delete', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script>
    $(document).ready(function(){
        ...
        $(date_time_picker[0]).val(<?php echo json_encode(date("d/m/Y H:i:s",strtotime($raffle->start_date))); ?>); // Inicio de sorteo
        $(date_time_picker[1]).val(<?php echo json_encode(date("d/m/Y H:i:s",strtotime($raffle->end_date))); ?>); // Cierre de sorteo
        $(date_time_picker[2]).val(<?php echo json_encode($raffle->raffle_date) == '"0000-00-00 00:00:00"' ? str_replace('-', '/', json_encode($raffle->raffle_date)) : json_encode(date("d/m/Y H:i:s",strtotime($raffle->raffle_date))); ?>); // Cierre de sorteo
        ...
        $(document).on('click', '.btn-delete-image', function(e) {
            ...
            let route = '<?php echo e(route("raffles.removeImage", ":file")); ?>';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/sortealo/resources/views/raffles/edit.blade.php ENDPATH**/ ?>