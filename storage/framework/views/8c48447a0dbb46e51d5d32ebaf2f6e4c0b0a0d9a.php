...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('img/logos/logo.png')); ?>">
    ...
    <style>
        ...
        body {           
            background-image: url("<?php echo e(asset('img/logos/back.png')); ?>");
...
<body>
    ...
    <?php echo $__env->make('sweetalert::alert', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-lg">
            <div class="container-fluid row bg-light">
                <a class="navbar-brand d-flex float-left pl-5 pr-3 pl-0" href="<?php echo e(url('/')); ?>">
                    <img class="pr-3 pl-0 pt-0 pb-0" src="<?php echo e(asset('/img/logos/logo.png')); ?>" width="50px" style="border-right: 1px #fd834f solid;"/>
                ...
                <div class="collapse navbar-collapse h4" id="navbarNavDropdown">
                    <ul class="navbar-nav pt-3 d-flex justify-content-between">
                        <li class="nav-item px-4 <?php echo e(\Request::route()->getName() == 'home' ? 'active' : ''); ?>">
                            <a class="nav-link rounded" href="/">Inicio <span class="sr-only">(current)</span></a>
                        </li>
                        <!-- <li class="nav-item px-4">
                            <a class="nav-link" href="<?php echo e(route('home')); ?>">Sorteos</a>
                        </li> -->
                        <li class="nav-item px-4 <?php echo e(\Request::route()->getName() == 'raffles.results' ? 'active' : ''); ?>">
                            <a class="nav-link rounded" href="<?php echo e(route('raffles.results')); ?>">Resultados</a>
                        </li>
                        <li class="nav-item px-4 <?php echo e(\Request::route()->getName() == 'faqs.index' ? 'active' : ''); ?>">
                            <a class="nav-link rounded" href="<?php echo e(route('faqs.index')); ?>">FAQ</a>
                        </li>
                        <li class="nav-item px-4 <?php echo e(\Request::route()->getName() == 'contact.index' ? 'active' : ''); ?>">
                            <a class="nav-link rounded" href="<?php echo e(route('contact.index')); ?>">Contacto</a>
                        </li>
                        <?php if(auth()->guard()->guest()): ?>
                        <li class="nav-item <?php echo e(\Request::route()->getName() == 'login' ? 'active' : ''); ?>" style="margin-right: 0;">
                        ...
                        <?php if(auth()->guard()->guest()): ?>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right cart-full-container rounded px-2" style="width: 25rem;" data-id="">
                                    ...
                                    <?php if(session()->get(session()->getId().'-') !== null && count(session()->get(session()->getId().'-')) > 0): ?> <!-- se verifica si ya se trae algo por sesion -->

                                        <div class="cart-container overflow-cart" style="max-height: 25rem;">
                                            <?php $__currentLoopData = session()->get(session()->getId().'-'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="cart-block-item border-bottom row" id="<?php echo e($item['raffle_id'] ?? ''); ?>" style="max-height: 100px; height:100px">
                                                    <div class="col-md-3 d-flex mx-auto">
                                                        <img src="<?php echo e(asset('storage/raffles/' . $item['photo'])); ?>" width="100%"> 
                                                    </div>
                                                    <div class="col-md-9 d-flex align-items-center">
                                                        <p class="title mb-0"><?php echo e($item['title'] ?? ''); ?></p>
                                                        <p class="col-4 mb-0 mr-0" id="<?php echo e($item['raffle_id'] ?? ''); ?>-price"><?php echo e($item['quantity'] ?? ''); ?> x $ <?php echo e($item['price'] ?? ''); ?></p>
                        ...
                        <?php else: ?>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="<?php echo e(route('panel.index')); ?>">Panel</a>

                                    <a class="dropdown-item" href="<?php echo e(route('users.profile', ['user' => Auth::user()->id])); ?>">Perfil</a>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $.ajax({
                type: 'get',
                url: '<?php echo e(route("cart.loadCart")); ?>',
            ...
            $('.cart-full-container').on('click', '.btn-delete-product',function(e){
                ...
                $.ajax({
                    ...
                    url: '<?php echo e(route("cart.deleteItemCart")); ?>',
                    success:function(response) {
            ...
            $('.cart-full-container, #reset-cart').on('click', '#reset-cart',function(e){
                $.ajax({
                    ...
                    url: '<?php echo e(route("cart.resetCart")); ?>',
                    success:function(response) {
...
<?php /**PATH /home/vagrant/code/sortealo/resources/views/layouts/app.blade.php ENDPATH**/ ?>