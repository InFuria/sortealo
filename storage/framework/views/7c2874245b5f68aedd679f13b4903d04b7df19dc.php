        ...
        <div class="content special-card col-md-11 pt-3 mx-auto min-vh-100">
            <div class="card bg-light col-12 min-vh-100 my-5">
                ...
                <div class="card-body d-flex justify-content-center align-items-center col-8 mx-auto">
                    <?php echo Form::open(['route' => ['users.profile.update', $user->id], 'method' => 'post', 'class' => 'col-md-10', 'files' => true]); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/sortealo/resources/views/users/profile.blade.php ENDPATH**/ ?>