  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="create-users-form" action="<?php echo e(route('raffleCategories.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
</div><?php /**PATH /home/vagrant/code/sortealo/resources/views/raffleCategories/partials/_create.blade.php ENDPATH**/ ?>