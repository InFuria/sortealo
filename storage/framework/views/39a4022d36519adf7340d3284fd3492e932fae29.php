            ...
            <div class="card bg-light col-12 min-vh-100 my-5">
                ...
                <div class="row">
                    <div class="mt-4">
                        ...
                        <a class="d-inline" href="<?php echo e(route('companies.create')); ?>" title="Crear empresa">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="candidates-list">
                                                <td class="title">
                                                <div class="thumb">
                                                    <?php if(isset($company->photo)): ?>
                                                        <img class="img-user ml-3" src="<?php echo e(asset('storage/companies/' . $company->photo)); ?>" alt="">
                                                    <?php else: ?>
                                                        <img class="img-user ml-3" src="<?php echo e(asset('storage/companies/default.png')); ?>" alt="">
                                                    <?php endif; ?>
                                                </div>
                                                <div class="candidate-list-details">
                                                    <div class="candidate-list-info">
                                                    <div class="candidate-list-title">
                                                        <h5 class="mb-0"><a href="<?php echo e(route('companies.edit', ['company' => $company->id])); ?>"><?php echo e($company->name); ?></a></h5>
                                                    </div>
                                                    <div class="candidate-list-option">
                                                        <ul class="list-unstyled">
                                                        <li><i class="fas fa-home pr-1"></i><?php echo e($company->address !== "" ? $company->address : "No registra direccion"); ?></li>
                                                        <li><i class="fas fa-phone pr-1"></i><?php echo e($company->phone !== "" ? $company->phone : 'No registra telefono'); ?></li>
                                                        </ul>
                                                    </div>
                                                    </div>
                                                </div>
                                                ...
                                                <td class="text-center">
                                                    <a href="#" class="badge badge-info text-white"><?php echo e($company->email); ?></a>
                                                </td>
                                                <td class="candidate-list-favourite-time text-center">
                                                    <?php if(isset($company->webpage)): ?>
                                                        <p><?php echo e($company->webpage); ?></p>
                                                    <?php elseif($company->status == 1): ?>
                                                        <p>No registra</p>
                                                    <?php endif; ?>
                                                </td>
                                                <td class="text-center">
                                                ...
                                                <td class="candidate-list-favourite-time text-center">
                                                    <p><?php echo e($company->created_at); ?></p>
                                                </td>
                                                <td>
                                                <ul class="list-unstyled mb-0 d-flex justify-content-end">
                                                    <?php if($company->status == 0): ?>
                                                        <li class="p-1"><a href="<?php echo e(route('companies.status', ['company' => $company->id])); ?>" class="text-success btn-status" title="Habilitar empresa"><i class="far fa-eye"></i></a></li>
                                                    <?php else: ?>
                                                        <li class="p-1"><a href="<?php echo e(route('companies.status', ['company' => $company->id])); ?>" class="text-danger btn-status" title="Deshabilitar empresa"><i class="fas fa-eye-slash"></i></a></li>
                                                    <?php endif; ?>
                                                    <li class="p-1"><a href="<?php echo e(route('companies.show', ['company'=> $company->id])); ?>" class="text-info" data-toggle="tooltip" title="Detalle empresa" data-original-title="Detalle"><i class="fas fa-info-circle"></i></a></li>
                                                    <li class="p-1"><a href="<?php echo e(route('companies.edit', ['company'=> $company->id])); ?>" class="text-success" data-toggle="tooltip" title="Editar empresa" data-original-title="Edit"><i class="fas fa-pencil-alt"></i></a></li>
<!--                                                     <li class="p-1"><a href="#" class="text-danger btn-delete" title="Eliminar empresa" data-id="<?php echo e($company->id); ?>" data-name="<?php echo e($company->name); ?>"><i class="far fa-trash-alt"></i></a></li>
 -->                                                </ul>
                                                </td>
                                            </tr>
...
<?php echo $__env->make('companies.partials._delete', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            $.ajax({
                ...
                success:function(data) {
                    ...
                    $.each(data.data, function( index, value ) {
                        ...
                        let edit = "<?php echo route('companies.edit', ':id'); ?>";
                        edit = edit.replace(':id', value.id);

                        let show = "<?php echo route('companies.show', ':id'); ?>";
                        show = show.replace(':id', value.id);

                        let statusRoute = "<?php echo route('companies.status', ':id'); ?>"
                        statusRoute = statusRoute.replace(':id', value.id);

                        let photo = value.photo !== "" && value.photo !== null ? "<img class='img-user ml-3' src='<?php echo e(asset('storage/companies/')); ?>/" + value.photo + "' alt=''>" : "<img class='img-user ml-3' src='<?php echo e(asset('storage/companies/default.png')); ?>' alt=''>";
...
$(document).on('click', '.btn-delete', function(e) {
    ...
    let route = '<?php echo e(route("companies.destroy", ":id")); ?>';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/sortealo/resources/views/companies/index.blade.php ENDPATH**/ ?>