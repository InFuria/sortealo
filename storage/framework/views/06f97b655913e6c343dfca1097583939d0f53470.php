<?php $__env->startSection('title', 'Detalle de Carrito'); ?>
                    ...
                    <?php if($details !== null): ?> 
                        <div class="col-9 user-dashboard-info-box mb-3 bg-white p-4 shadow-sm">
                            <div class="col-12 wrapper px-0">
                                            ...
                                            <tr>
                                                <td class="text-left">
                                                    <div class="row d-flex">
                                                        <div class="col-2 d-flex ml-0 mr-auto">
                                                            <img src="<?php echo e(asset('storage/raffles')); ?>/<?php echo e($item['photo']); ?>" width="100%" class="" style="max-height: 100px; height:100px">
                                                        </div>
                                                ...
                                                <td class="text-center col-2 align-middle">
                                                    <div class="d-flex d-inline justify-content-center">
                                                        ...
                                                        <div>
                                                            <input type="text" class="border-0 text-center" step="1" min="1" name="quantity" value="<?php echo e($item['quantity']); ?>" title="Cantidad" size="2" inputmode="numeric" id="quantity-input">
                                                        </div>
                                                        <button type="button"id="plus" class="btn border-16 bg-orange btn-sm"><i class="fas fa-plus fa-sm"></i></button>
                                                    </div>
                                                </td>
                                                <td class="text-center col-1 align-middle">USD. <?php echo e($item['price']); ?></td>
                                                <td class="text-center col-1 align-middle">USD. <?php echo e($item['subTotal']); ?></td>
                                            </tr>
                                ...
                                <div class="p-3">
                                    <form action="<?php echo e(route('cart.resetCart')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                    ...
                                    <tbody>
                                        <tr class="cart-subtotal">
                                            ...
                                            <td data-title="Subtotal">
                                                <span class="ecommercepro-Price-amount amount" id="cart-subtotal"><?php echo e($quantity); ?></span>
                                            </td>
                                        </tr>
                                        <tr class="cart-subtotal">
                                            <th>Tipo de pago</th>
                                        ...
                                        <tr class="order-total">
                                            ...
                                            <td data-title="Total">
                                                <strong>
                                                    <span class="ecommercepro-Price-amount amount" id="cart-total"><?php echo e($total); ?></span>
                                                </strong>
                                            </td>
                                        </tr>
                                    </tbody>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/sortealo/resources/views/cart/preview.blade.php ENDPATH**/ ?>