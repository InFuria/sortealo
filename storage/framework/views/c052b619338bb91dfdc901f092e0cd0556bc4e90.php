...
<div class="form-group mt-5">
    ...
    <div class="col-md-12">
        ...
        <input id="question" type="text" class="form-control form-control-lg <?php $__errorArgs = ['question'];
...
unset($__errorArgs, $__bag); ?>" name="question" value="<?php echo e(isset($faq) ? $faq->question : old('question')); ?>" required autocomplete="question" autofocus>
...
<div class="form-group">
    ...
    <div class="col-md-12">
        <input id="answer" type="text" class="form-control form-control-lg <?php $__errorArgs = ['answer'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="answer" value="<?php echo e(isset($faq) ? $faq->answer : old('answer')); ?>" required autocomplete="answer" autofocus>
...
</div><?php /**PATH /home/vagrant/code/sortealo/resources/views/faqs/partials/_form.blade.php ENDPATH**/ ?>